...
namespace lab2
{
  public partial class Form1 : Form
  {
    ...
    private void pictureBox_MouseUp(object sender, MouseEventArgs e)
    {
      ...
      {
        shapeObjectsEditor.InitPen(Color.Black, Color.Yellow, DashStyle.Solid, (float)brushSizePicker.Value);
    ...
    private void pictureBox_MouseDown(object sender, MouseEventArgs e)
    {
      if (e.Button == MouseButtons.Left)
      {
        ...
        shapeObjectsEditor.InitPen(Color.Black, Color.Yellow, DashStyle.Dash, (float)brushSizePicker.Value);
